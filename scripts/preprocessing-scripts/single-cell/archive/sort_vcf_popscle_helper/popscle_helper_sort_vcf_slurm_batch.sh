...
#SBATCH --job-name=popscle_helper_sortVCF_1000g_ref
...
/nfs/turbo/bakulski1/Datasets/Placenta_Single_Cell/ruddle.brcf.med.umich.edu/Run_2250/KC40_1_placenta/outs/possorted_genome_bam.bam \
...
> $dir/1000g_ref_sorted_as_in_bam.vcf