...
p1 <- ggplot(data = base.graph, mapping = aes(x = NES, y = fct_rev(fct_reorder(NAME, NES)), fill = `FDR q-val`)) +
  ...
  theme_minimal(base_size = 20) + theme(legend.position = "bottom", legend.text = element_text(angle = 45), axis.text.y = element_text(color = "black")) + labs(fill = "False discovery rate-adjusted p-value")
...
p2 <- ggplot(data = pc.graph, mapping = aes(x = NES, y = fct_rev(fct_reorder(NAME, NES)), fill = `FDR q-val`)) +
  ...
  theme_minimal(base_size = 20) + theme(legend.position = "bottom", legend.text = element_text(angle = 45), axis.text.y = element_text(color = "black"))
p2
