...
Should I include cluster assignment from SingleR?
Should I use de novo clusters?
Should I up the doublet rate for 10x v1 chemistry? The most important hyperparameter for doublet calling?
```{r}
set.seed(1)
