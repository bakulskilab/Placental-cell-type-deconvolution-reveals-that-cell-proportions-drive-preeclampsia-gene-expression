...
#saveRDS(object = all.markers, file = here("data", "all_markers_cleaned_combined_tsang_seurat_2022-04-18.rda"))
```
...
```{r}
markers %>% filter(cluster %in% "Fetal Naive CD8+ T Cells") %>% View
markers %>% filter(cluster %in% "Fetal CD8+ Cytotoxic T Cells") %>% View
markers %>% filter(cluster %in% "Fetal Naive CD4+ T Cells") %>% View
```
...
all.cluster.markers.colnames <- c("Cell type cluster", "Gene", "log2 Fold-change", "Percentage cluster cells expressing gene", "Percentage other cells expressing gene", "P-value", "Bonferroni-adjusted p-value")
...
top10.colnames <- c("Cell type cluster", "Gene", "log2 Fold-change", "Percentage cluster cells expressing gene", "Percentage other cells expressing gene", "P-value", "Bonferroni-adjusted p-value")
