...
count \
--id=batch_kc_42_2 \
--fastqs=/nfs/turbo/bakulski1/Datasets/Placenta_Single_Cell/V2/ruddle.brcf.med.umich.edu/Run_2250/outs/fastq_path/HTCVVBBXX/KC42_2_placenta \
--sample=KC42_2_placenta \
