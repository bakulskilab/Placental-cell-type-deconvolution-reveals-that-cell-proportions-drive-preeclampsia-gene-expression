...
count \
--id=batch_kc_42_1 \
--fastqs=/nfs/turbo/bakulski1/Datasets/Placenta_Single_Cell/V2/ruddle.brcf.med.umich.edu/Run_2250/outs/fastq_path/HTCVVBBXX/KC42_1_placenta \
--sample=KC42_1_placenta \
