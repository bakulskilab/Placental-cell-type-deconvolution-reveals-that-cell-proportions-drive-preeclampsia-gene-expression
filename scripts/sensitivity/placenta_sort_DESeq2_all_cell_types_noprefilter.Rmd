...
No Pre-filtering: normalized counts greater than 10 per gene and detected in at least three samples, as recommended in the DESeq2 paper to address bimodal p-value distribution.
...
make_gsea_input <- function(res, title) {
  ...
  write_tsv(return, here("results", "GSEA", "sorted", paste0(title, "_all_cell_types_noprefilter_gsea_input_stats_", Sys.Date(), ".rnk")), col_names = FALSE)
