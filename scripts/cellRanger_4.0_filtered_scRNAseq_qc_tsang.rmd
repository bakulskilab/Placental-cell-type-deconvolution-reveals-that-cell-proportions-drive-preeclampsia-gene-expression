...
LIBRARY.ID <- c("1A", "1B", "2A", "2B", "3", "4", "5", "6", "7", "8A", "8B", "9A", "9B", "PE1", "PE2", "PE3", "PE4")
...
# Sex of samples
FETAL.SEX <- c("F", "F", "M", "M", "M", "F", "M", NA, NA, NA, NA, NA, NA, NA, NA, NA, NA)
```
...
rna.vln <- plotColData(sce.combined, x="sample", y="sum", colour_by="discard") + 
...
gene.vln <- plotColData(sce.combined, x="sample", y="detected", colour_by="discard") + 
...
mito.vln <- plotColData(sce.combined, x="sample", y="subsets_Mito_percent", 
