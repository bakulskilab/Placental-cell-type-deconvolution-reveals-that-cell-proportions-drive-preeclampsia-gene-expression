...
Updated code (3/2021) and outstanding questions:
...
We'll begin by transforming the data to the log-fold-2 scale using the same shrinkage transformation employed in the DEX pipeline without prefiltering.
```{r transformation}
...
103911 - leukocyte is an extreme outlier on blind PCA analysis, will remove and rerun. PCA looks similar with 103911 - do not remove
```{r}
