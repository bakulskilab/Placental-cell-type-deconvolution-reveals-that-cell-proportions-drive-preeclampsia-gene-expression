...
count \
--id=batch_kc_40_2 \
--fastqs=/nfs/turbo/bakulski1/Datasets/Placenta_Single_Cell/V2/ruddle.brcf.med.umich.edu/Run_2250/outs/fastq_path/HTCVVBBXX/KC40_2_placenta \
--sample=KC40_2_placenta \
