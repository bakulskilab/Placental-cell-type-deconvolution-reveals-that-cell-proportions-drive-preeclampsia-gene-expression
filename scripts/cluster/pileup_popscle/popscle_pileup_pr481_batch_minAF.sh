...
#SBATCH --job-name=popscle_pileup_pr481_minAF
...
# make output dir
rm -r /nfs/turbo/bakulski1/People/kyleac/placenta_single_cell/popscle_out/pr_481_minAF
mkdir /nfs/turbo/bakulski1/People/kyleac/placenta_single_cell/popscle_out/pr_481_minAF
...
--sam /nfs/turbo/bakulski1/People/kyleac/placenta_single_cell/reference/pr481.minAF.bam \
--vcf /nfs/turbo/bakulski1/People/kyleac/placenta_single_cell/reference/1000g.minAF-0.1.reheader.vcf \
--out /nfs/turbo/bakulski1/People/kyleac/placenta_single_cell/popscle_out/pr_481_minAF/pileupOUT \
